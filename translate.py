...
model1 = Word2Vec.load("C:\develop\DataScienceMaster\Translate\saved_models\embeddings4.model")
model2 = Word2Vec.load("C:\develop\DataScienceMaster\Translate\saved_models\embeddings5.model")
...
def get_sentences(content): 
   natural_count = sent_tokenize(content)
...
def collect_non_dict2(texts):
    ...
    #get the compliment of the all text and known english words (by python standards)
...
if __name__ == "__main__":
    ...
    startTime = time.time()
    all_found_ngrams=collect_ngrams2(texts)
